...
import { booleanvaluableProps } from '../../../@types/Admin';
const { Option } = Select;

function UpdateModal ({userdata,editu,onclose,userid,handlesub}:{
  userdata:any,
  editu:boolean,
  onclose:()=>void,
  userid:string,
  handlesub:()=>void
    ...
    const { handleSubmit, handleChange, handleBlur, values, errors, touched,setFieldValue } = useFormik<formikaddnewvaluesProps>({
      ...
      const handleedit=(values:formikaddnewvaluesProps)=>{
...
<Form.Item
    ...
    <Form.Item 
        ...
        help={touched.dealer_id && errors.dealer_id==='string' ? errors.dealer_id : ''}
    >
        <Select
            // name="dealer_id"
