...
import { handleaddmodal, handledealerid, handlemodal, handleuserid, handleuserType,handlefilter } from '../../../redux/reducers/AuthReducers';
...
<Pagination
            ...
            {addnew && (
                ...
                <AddNew userdata={userdata}  onclose={()=>{
