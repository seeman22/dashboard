...
function Login() {
  ...
  const [email, setEmail] = useState(""); // Adding another input state for email
                    ...
                    endAdornment: (
                      <InputAdornment position="end">
                        <IconButton onClick={togglePasswordVisibility}>
                          {showPassword ? (
                            <Visibility style={{ color: "white" }} /> // White eye icon
                          ) : (
                            <VisibilityOff style={{ color: "white" }} /> // White eye-off icon
                          )}
                        </IconButton>
                      </InputAdornment>
                    ),
