...
function Signup() {
    ...
    return (
       ...
       className={`img-fluid ${classes.back}`} justify="center"
        >
            <Col xs={24} sm={16} md={8} >
            <Card title={<h2 className={classes.cardTitle}       style={{ color: 'white' }}>Forgot Password</h2>} className={`card w-100 mt-5 p-4 mx-auto ${classes.cardsssss}`}       style={{ color: 'white' }}>
        ...
        <Row justify="center">
        <p className='bold mt-3'>Enter your recovery email and change your password   .</p>
        <UnlockTwoTone />
        </Row>
  ...
  FormHelperTextProps={{ sx: { color: '#00488c' } }} 
  fullWidth
/>
 <Row justify="end" >
      <Button className="btn btn-primary mt-5 mb-2 w-25" type="primary" htmlType="submit">Next</Button>
      </Row>
